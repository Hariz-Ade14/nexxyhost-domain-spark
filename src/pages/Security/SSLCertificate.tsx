...
export default function SSLCertificatesPage() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Display security indicators that customers recognize and trust",
      icon: Shield,
    },
    {
      title: "Improve SEO Rankings",
      description:
        "Google gives preference to secure HTTPS websites in search results",
      icon: CheckCircle,
    },
    {
      title: "PCI Compliance",
      description:
        "Meet payment card industry requirements for online transactions",
      icon: Check,
    },
  ];
  ...
  const sslFaqData = [
    {
      ...
      answer:
        "An SSL (Secure Sockets Layer) certificate is a digital certificate that authenticates a website's identity and enables an encrypted connection. It ensures that all data passed between the web server and browser remains private and secure.",
    },
    {
      question: "What's the difference between SSL certificate types?",
      answer:
        "The main differences are in the validation process and visual indicators. DV certificates verify domain ownership only and are issued quickly. OV certificates verify both domain ownership and organization details. EV certificates require the most rigorous verification and provide the highest level of trust with special browser indicators.",
    },
    {
      question: "How long does it take to issue an SSL?",
      answer:
        "DV certificates can be issued within minutes to a few hours. OV certificates typically take 1-3 business days for verification and issuance. EV certificates require the most thorough validation and usually take 3-5 business days to issue.",
    },
    {
      question: "Do I need technical knowledge to install SSL?",
      answer:
        "No! If you host with us, we offer one-click SSL installation or our support team can install it for you at no extra charge. For customers hosting elsewhere, we provide detailed installation guides and can offer installation assistance for a small fee.",
    },
  ];
  return (
    <Layout>
        ...
        <section className="bg to-teal-700 text-white py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="mb-6 text-4xl font-bold tracking-tight sm:text-6xl text-teal-900">
                SSL Certificates
              </h1>
              <p className="mb-8 text-base text-black max-w-2xl mx-auto">
                Secure your website with industry-standard SSL encryption. Build
                customer trust, improve SEO rankings, and protect sensitive data
                with our range of SSL certificate options.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-black">
                Select the right level of validation for your website needs
              </p>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-3 max-w-6xl mx-auto">
              {sslTypes.map((ssl, index) => (
                <Card
                  key={index}
                  className={`relative ${ssl.color} ${
                    ssl.popular ? "ring-2 ring-teal-900 scale-105" : ""
              ...
              <div className="grid gap-12 lg:grid-cols-2 items-center">
                ...
                <div>
                  ...
                  <p className="text-lg text-black mb-6">
                    SSL certificates create an encrypted connection between your
                    website and your visitors' browsers, ensuring that all data
                    passed between them remains private and secure. In today's
                    digital landscape, SSL is no longer optional—it's essential.
                  </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-black max-w-2xl mx-auto">
                Protect your website and your customers with industry-standard
                security
              </p>
            </div>
              ...
              <div className="grid gap-8 md:grid-cols-3">
                <div className="text-center">
                  ...
                  <p className="text-black">
                    Choose the SSL certificate type that best fits your
                    website's needs and complete your purchase
                  </p>
                </div>
                <div className="text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-teal-500 to-cyan-500 text-white text-2xl font-bold">
                  ...
                  <p className="text-black">
                    Complete the validation process to verify your domain
                    ownership or business identity
                  </p>
                </div>
                <div className="text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-teal-500 to-cyan-500 text-white text-2xl font-bold">
                  ...
                  <p className="text-black">
                    Our team installs and configures your SSL certificate, or
                    use our one-click installation tool
                  </p>
                </div>
              </div>
            </div>
