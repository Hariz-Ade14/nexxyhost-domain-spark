...
import { ArrowRight, Shield, Clock, Users, CheckCircle, RefreshCw } from 'lucide-react';
  ...
  const migrationSteps = [
    {
      step: 1,
      title: 'Site Analysis',
      description: 'We analyze your current website and hosting setup to plan the perfect migration strategy.'
    },
    {
      step: 2,
      title: 'Data Backup',
      description: 'Complete backup of all your files, databases, and configurations to ensure nothing is lost.'
    },
    {
      step: 3,
      title: 'Transfer Process',
      description: 'Secure transfer of all website data to our optimized servers with minimal downtime.'
    },
    {
      step: 4,
      title: 'Testing & Verification',
      description: 'Thorough testing to ensure everything works perfectly on our platform.'
    },
    {
      step: 5,
      title: 'DNS Update',
      description: 'Seamless DNS transition to point your domain to our servers.'
    },
    {
      step: 6,
      title: 'Post-Migration Support',
      description: '30 days of dedicated support to ensure everything runs smoothly.'
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: 'Complete backup and verification process ensures 100% data integrity'
    },
    {
      icon: Clock,
      title: 'Minimal Downtime',
      description: 'Expert migration process minimizes website downtime to mere minutes'
    },
    {
      icon: Users,
      title: 'Expert Migration Team',
      description: 'Dedicated specialists handle every aspect of your migration'
    },
    {
      icon: CheckCircle,
    ...
    },
    {
      ...
      description: 'If something goes wrong, we\'ll re-migrate your site at no extra cost'
    },
    {
      icon: ArrowRight,
      title: 'Any Platform',
      description: 'We migrate from any hosting provider or platform to our servers'
    }
  ];

  const supportedPlatforms = [
    'WordPress', 'Drupal', 'Joomla', 'Magento', 'PrestaShop', 'OpenCart',
    'Custom PHP Applications', 'Static HTML Sites', 'Laravel Applications',
    'CodeIgniter', 'Symfony', 'CakePHP', 'Node.js Applications', 'Python Applications'
  ];
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-semibold text-teal-700">Zero Downtime</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {supportedPlatforms.map((platform, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition-all transform hover:-translate-y-1">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white bg-opacity-10 p-8 rounded-2xl backdrop-blur-sm">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-4">Complete Migration Package</h3>
                <ul className="space-y-3 text-left">
                  <li className="flex items-center"><CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" />Full website backup and transfer</li>
                  <li className="flex items-center"><CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" />Database migration and optimization</li>
                  <li className="flex items-center"><CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" />Email accounts migration</li>
                  <li className="flex items-center"><CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" />DNS management and updates</li>
                  <li className="flex items-center"><CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" />SSL certificate installation</li>
                  <li className="flex items-center"><CheckCircle className="h-5 w-5 mr-3 flex-shrink-0" />30 days post-migration support</li>
                </ul>
              </div>
